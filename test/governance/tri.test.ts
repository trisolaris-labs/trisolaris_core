...
describe('Tri', () => {
  ...
  it('mints', async () => {
    await expect(tri.connect(wallet0).mint(wallet1.address, 1)).to.be.revertedWith('Tri::mint: only the minter can mint')
    await expect(tri.mint('0x0000000000000000000000000000000000000000', 1)).to.be.revertedWith('Tri::mint: cannot transfer to the zero address')
