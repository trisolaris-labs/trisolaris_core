...
// TriBar is the coolest bar in town. You come in with some Tri 
// and leave with more! The longer you stay, the more Tri you get
//
...
contract TriBar is ERC20("TriBar", "xTRI") {
    ...
    function enter(uint256 _triAmount) public {
        ...
        // The ratio will change overtime, as xTri is burned/minted and Tri deposited + gained from fees / withdrawn.
        else {
